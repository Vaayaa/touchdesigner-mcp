 ...
 */
const TD_PYTHON_CLASS_REFERENCE_BASE_URL = "https://docs.derivative.ca";
const TD_PYTHON_CLASS_REFERENCE_INDEX_URL = `${TD_PYTHON_CLASS_REFERENCE_BASE_URL}/Python_Classes_and_Modules`;

/**
 * Reference Tool Names for TouchDesigner MCP
 */
const TOOL_NAMES = {
    // NEW: Connect two nodes
    CONNECT_TD_NODES: "connect_td_nodes",
...
const REFERENCE_COMMENT = `Check reference resources: ${TD_PYTHON_CLASS_REFERENCE_INDEX_URL}`;
...
export { TD_PYTHON_CLASS_REFERENCE_BASE_URL, TD_PYTHON_CLASS_REFERENCE_INDEX_URL, TOOL_NAMES, REFERENCE_COMMENT, PROMPT_NAMES };
